...
Gender() {
    res=$($1 | awk -F "," -v a=$a -v ta=$TIMEAFTER -v b=$b -v tb=$TIMEBEFORE -v g=$g -v gender=$GENDER 'BEGIN {m = 0;z = 0} NR != 1 { error=0; if ( ! /^\s*$/ && strftime("%Y-%m-%d",mktime(gensub(/^\s*(.{4})-(..)-(..)\s*$/,"\\1 \\2 \\3 0 0 0 ",1,$2))) != gensub(/^\s*(.{4})-(..)-(..)\s*$/,"\\1-\\2-\\3",1,$2)) { error++; print ("Invalid date: "$1","$2","$3","$4","$5","$6","$7","$8","$9) > "/dev/stderr" }; if ( ! /^\s*$/ && $3 !~ /^\s*[0-9]*\s*$/) { error++; print ("Invalid age: "$1","$2","$3","$4","$5","$6","$7","$8","$9) > "/dev/stderr" }; if ( ! /^\s*$/ && error == 0 && (a==0 || (a==1 && $2 >= ta)) && (b==0 || (b==1 && $2 <= tb)) && (g==0 || (g==1 && $4 == gender)) ) { if ($4 == "M") m++; else z++ } }
    END {
        print m","z;
    }')
    GENDERM=$((GENDERM + ${res%,*}))
...
Age() {
    for line in $($1 | awk -F "," -v a=$a -v ta=$TIMEAFTER -v b=$b -v tb=$TIMEBEFORE -v g=$g -v gender=$GENDER 'NR != 1 { error=0; if ( ! /^\s*$/ && strftime("%Y-%m-%d",mktime(gensub(/^\s*(.{4})-(..)-(..)\s*$/,"\\1 \\2 \\3 0 0 0 ",1,$2))) != gensub(/^\s*(.{4})-(..)-(..)\s*$/,"\\1-\\2-\\3",1,$2)) { error++; print ("Invalid date: "$1","$2","$3","$4","$5","$6","$7","$8","$9) > "/dev/stderr" }; if ( ! /^\s*$/ && $3 !~ /^\s*[0-9]*\s*$/) { error++; print ("Invalid age: "$1","$2","$3","$4","$5","$6","$7","$8","$9) > "/dev/stderr" }; if ( ! /^\s*$/ && error == 0 && (a==0 || (a==1 && $2 >= ta)) && (b==0 || (b==1 && $2 <= tb)) && (g==0 || (g==1 && $4 == gender)) ) { print (length($3) != 0) ? $3 : "None";} }'); do
...
Merge() {
    $1 | awk -F "," -v a=$a -v ta=$TIMEAFTER -v b=$b -v tb=$TIMEBEFORE -v g=$g -v gender=$GENDER 'NR != 1 { error=0; if ( ! /^\s*$/ && strftime("%Y-%m-%d",mktime(gensub(/^\s*(.{4})-(..)-(..)\s*$/,"\\1 \\2 \\3 0 0 0 ",1,$2))) != gensub(/^\s*(.{4})-(..)-(..)\s*$/,"\\1-\\2-\\3",1,$2)) { error++; print ("Invalid date: "$1","$2","$3","$4","$5","$6","$7","$8","$9) > "/dev/stderr" }; if ( ! /^\s*$/ && $3 !~ /^\s*[0-9]*\s*$/) { error++; print ("Invalid age: "$1","$2","$3","$4","$5","$6","$7","$8","$9) > "/dev/stderr" }; if ( ! /^\s*$/ && error == 0 && (a==0 || (a==1 && $2 >= ta)) && (b==0 || (b==1 && $2 <= tb)) && (g==0 || (g==1 && $4 == gender)) ) { print $1","$2","$3","$4","$5","$6","$7","$8","$9} }'
}
...
Daily() {
    for line in $($1 | awk -F "," -v a=$a -v ta=$TIMEAFTER -v b=$b -v tb=$TIMEBEFORE -v g=$g -v gender=$GENDER 'NR != 1 { error=0; if ( ! /^\s*$/ && strftime("%Y-%m-%d",mktime(gensub(/^\s*(.{4})-(..)-(..)\s*$/,"\\1 \\2 \\3 0 0 0 ",1,$2))) != gensub(/^\s*(.{4})-(..)-(..)\s*$/,"\\1-\\2-\\3",1,$2)) { error++; print ("Invalid date: "$1","$2","$3","$4","$5","$6","$7","$8","$9) > "/dev/stderr" }; if ( ! /^\s*$/ && $3 !~ /^\s*[0-9]*\s*$/) { error++; print ("Invalid age: "$1","$2","$3","$4","$5","$6","$7","$8","$9) > "/dev/stderr" }; if ( ! /^\s*$/ && error == 0 && (a==0 || (a==1 && $2 >= ta)) && (b==0 || (b==1 && $2 <= tb)) && (g==0 || (g==1 && $4 == gender)) ) { print (length($2) != 0) ? $2 : "None";} }'); do
        keyValueArray[$line]=$((keyValueArray[$line]+1))
    done
}
...
Monthly() {
    for line in $($1 | awk -F "," -v a=$a -v ta=$TIMEAFTER -v b=$b -v tb=$TIMEBEFORE -v g=$g -v gender=$GENDER 'NR != 1 { error=0; if ( ! /^\s*$/ && strftime("%Y-%m-%d",mktime(gensub(/^\s*(.{4})-(..)-(..)\s*$/,"\\1 \\2 \\3 0 0 0 ",1,$2))) != gensub(/^\s*(.{4})-(..)-(..)\s*$/,"\\1-\\2-\\3",1,$2)) { error++; print ("Invalid date: "$1","$2","$3","$4","$5","$6","$7","$8","$9) > "/dev/stderr" }; if ( ! /^\s*$/ && $3 !~ /^\s*[0-9]*\s*$/) { error++; print ("Invalid age: "$1","$2","$3","$4","$5","$6","$7","$8","$9) > "/dev/stderr" }; if ( ! /^\s*$/ && error == 0 && (a==0 || (a==1 && $2 >= ta)) && (b==0 || (b==1 && $2 <= tb)) && (g==0 || (g==1 && $4 == gender)) ) { print (length($2) != 0) ? $2 : "None";} }' | awk -F "-" '{ print (length($1)+length($2) != 0) ? $1"-"$2 : "None"; }'); do
        keyValueArray[$line]=$((keyValueArray[$line]+1))
    done
}
...
Yearly() {
    for line in $($1 | awk -F "," -v a=$a -v ta=$TIMEAFTER -v b=$b -v tb=$TIMEBEFORE -v g=$g -v gender=$GENDER 'NR != 1 { error=0; if ( ! /^\s*$/ && strftime("%Y-%m-%d",mktime(gensub(/^\s*(.{4})-(..)-(..)\s*$/,"\\1 \\2 \\3 0 0 0 ",1,$2))) != gensub(/^\s*(.{4})-(..)-(..)\s*$/,"\\1-\\2-\\3",1,$2)) { error++; print ("Invalid date: "$1","$2","$3","$4","$5","$6","$7","$8","$9) > "/dev/stderr" }; if ( ! /^\s*$/ && $3 !~ /^\s*[0-9]*\s*$/) { error++; print ("Invalid age: "$1","$2","$3","$4","$5","$6","$7","$8","$9) > "/dev/stderr" }; if ( ! /^\s*$/ && error == 0 && (a==0 || (a==1 && $2 >= ta)) && (b==0 || (b==1 && $2 <= tb)) && (g==0 || (g==1 && $4 == gender)) ) { print (length($2) != 0) ? $2 : "None";} }' | awk -F "-" '{ print (length($1) != 0) ? $1 : "None"; }'); do
        keyValueArray[$line]=$((keyValueArray[$line]+1))
    done
}
...
Districts() {
    for line in $($1 | awk -F "," -v a=$a -v ta=$TIMEAFTER -v b=$b -v tb=$TIMEBEFORE -v g=$g -v gender=$GENDER 'NR != 1 { error=0; if ( ! /^\s*$/ && strftime("%Y-%m-%d",mktime(gensub(/^\s*(.{4})-(..)-(..)\s*$/,"\\1 \\2 \\3 0 0 0 ",1,$2))) != gensub(/^\s*(.{4})-(..)-(..)\s*$/,"\\1-\\2-\\3",1,$2)) { error++; print ("Invalid date: "$1","$2","$3","$4","$5","$6","$7","$8","$9) > "/dev/stderr" }; if ( ! /^\s*$/ && $3 !~ /^\s*[0-9]*\s*$/) { error++; print ("Invalid age: "$1","$2","$3","$4","$5","$6","$7","$8","$9) > "/dev/stderr" }; if ( ! /^\s*$/ && error == 0 && (a==0 || (a==1 && $2 >= ta)) && (b==0 || (b==1 && $2 <= tb)) && (g==0 || (g==1 && $4 == gender)) ) { print (length($6) != 0) ? $6 : "None";} }'); do
        keyValueArray[$line]=$((keyValueArray[$line]+1))
    done
}
...
Regions() {
    for line in $($1 | awk -F "," -v a=$a -v ta=$TIMEAFTER -v b=$b -v tb=$TIMEBEFORE -v g=$g -v gender=$GENDER 'NR != 1 { error=0; if ( ! /^\s*$/ && strftime("%Y-%m-%d",mktime(gensub(/^\s*(.{4})-(..)-(..)\s*$/,"\\1 \\2 \\3 0 0 0 ",1,$2))) != gensub(/^\s*(.{4})-(..)-(..)\s*$/,"\\1-\\2-\\3",1,$2)) { error++; print ("Invalid date: "$1","$2","$3","$4","$5","$6","$7","$8","$9) > "/dev/stderr" }; if ( ! /^\s*$/ && $3 !~ /^\s*[0-9]*\s*$/) { error++; print ("Invalid age: "$1","$2","$3","$4","$5","$6","$7","$8","$9) > "/dev/stderr" }; if ( ! /^\s*$/ && error == 0 && (a==0 || (a==1 && $2 >= ta)) && (b==0 || (b==1 && $2 <= tb)) && (g==0 || (g==1 && $4 == gender)) ) { print (length($5) != 0) ? $5 : "None";} }'); do
        keyValueArray[$line]=$((keyValueArray[$line]+1))
    done
}
...
Countries() {
    for line in $($1 | awk -F "," -v a=$a -v ta=$TIMEAFTER -v b=$b -v tb=$TIMEBEFORE -v g=$g -v gender=$GENDER 'NR != 1 { error=0; if ( ! /^\s*$/ && strftime("%Y-%m-%d",mktime(gensub(/^\s*(.{4})-(..)-(..)\s*$/,"\\1 \\2 \\3 0 0 0 ",1,$2))) != gensub(/^\s*(.{4})-(..)-(..)\s*$/,"\\1-\\2-\\3",1,$2)) { error++; print ("Invalid date: "$1","$2","$3","$4","$5","$6","$7","$8","$9) > "/dev/stderr" }; if ( ! /^\s*$/ && $3 !~ /^\s*[0-9]*\s*$/) { error++; print ("Invalid age: "$1","$2","$3","$4","$5","$6","$7","$8","$9) > "/dev/stderr" }; if ( ! /^\s*$/ && error == 0 && (a==0 || (a==1 && $2 >= ta)) && (b==0 || (b==1 && $2 <= tb)) && (g==0 || (g==1 && $4 == gender)) ) { print (length($8) != 0) ? $8 : "None";} }'); do
        keyValueArray[$line]=$((keyValueArray[$line]+1))
    done
}
